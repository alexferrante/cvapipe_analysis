...
class Distributor:
    ...
    def __init__(self, control, step_name):
        self.jobs = []
        ...
        self.abs_path_to_distribute = control.get_staging() / f".distribute-{step_name}"
...
class MorphParameterizationDistributor(Distributor):
    def __init__(self, control):
        super().__init__(control, "morphparameterization")
        self.rel_path_to_python_file = "cvapipe_analysis/steps/morph_parameterization/morph_parameterization_tools.py"
